  ...
  return (
    <div className="mb-4">
      ...
      <div className="relative">
        <input
          className={`w-full px-4 py-2 bg-gray-800 border rounded-lg focus:ring-2 focus:ring-gold-500/50 focus:border-gold-500 transition-colors text-theme-text-main placeholder-gray-500 ${
