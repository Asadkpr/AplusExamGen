        ...
        <div className="max-w-3xl mx-auto space-y-8">
          ...
          <div className="bg-gray-800 border border-gold-600/30 rounded-2xl shadow-2xl overflow-hidden">
             <div className="bg-gray-950/50 p-8 text-center border-b border-gray-700 relative">
               ...
               <h2 className="text-2xl font-bold text-theme-text-main tracking-wide">NAUMAN ALI</h2>
             ...
             <div className="p-8 text-theme-text-muted leading-relaxed text-center space-y-4">
               <h3 className="text-xl font-semibold text-theme-text-main mb-2">Welcome to APlus ExamGen</h3>
               <p className="italic text-theme-text-muted">“Pakistan’s most reliable and intelligent exam generator designed for teachers.”</p>
               ...
               <div className="text-left text-sm md:text-base space-y-4 mt-6 px-4 md:px-12">
                 ...
                 <div className="bg-gold-500/10 border-l-4 border-gold-500 p-4 rounded-r-lg my-4">
                   <p className="font-bold text-gold-600 text-center">To save teachers’ time and improve the quality of assessments.</p>
                 </div>
                 <p className="text-theme-text-muted">
